                            ...
                            {currentFacilities.map((facility, index) => (
                                ...
                                >
                                    ...
                                    <div className="absolute top-2 left-2 md:top-4 md:left-4">
                                        <span className="px-2 py-1 bg-white/20 backdrop-blur-sm text-white text-[10px] md:text-xs rounded-full">
                                            {categories.find(c => c.id === facility.category)?.icon}
                                        </span>
                                    </div>
                                    <div className="absolute inset-0 flex items-end justify-center p-2 md:p-4">
                                        <h3 className="text-white font-bold text-xs md:text-base lg:text-lg text-center">
                                            {facility.title}
                                        </h3>
                                    </div>
                                </div>
